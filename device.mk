...
# ANXCamera
# $(call inherit-product-if-exists, $(LOCAL_PATH)/ANXCamera/anx-vendor.mk)
...
# Pixel atrace HAL
PRODUCT_PACKAGES += android.hardware.atrace@1.0-service.pixel
...
# HW crypto
PRODUCT_PACKAGES += vendor.qti.hardware.cryptfshw@1.0-service-qti.qsee
...
PRODUCT_PACKAGES += android.hardware.broadcastradio@1.0-impl
...
# Biometrics
PRODUCT_PACKAGES += android.hardware.biometrics.fingerprint@2.1-service.xiaomi_sm6250
...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/rootdir/etc/init.joyeuse.rc:$(TARGET_COPY_OUT_VENDOR)/etc/init/init.joyeuse.rc \
...
PRODUCT_DEFAULT_PROPERTY_OVERRIDES += ro.vendor.qti.va_aosp.support=1
...
# USB
PRODUCT_PACKAGES += vendor.qti.hardware.vibrator@1.2-service
...
# Displayfeature
PRODUCT_PACKAGES += vendor.xiaomi.hardware.displayfeature@1.0.vendor
...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/nfc/libpn553_fw.so:$(TARGET_COPY_OUT_VENDOR)/lib/libpn553_fw.so
